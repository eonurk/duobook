...
const validateFirebaseConfig = () => {
    ...
    if (missingFields.length > 0) {
        console.error(`Missing Firebase configuration values: ${missingFields.join(", ")}`);
        console.error("Make sure your .env file contains all necessary VITE_FIREBASE_* variables");
        return false;
    }
    return true;
};
